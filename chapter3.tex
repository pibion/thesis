...
The neutron detectors are large strips of high density polyethylene (HDPE) plastic doped with scintillator (what kind of scintillator??).  They sit roughly in a large circle around the target.  The information that these detectors are sensitive to is energy deposition and time.  Energy deposition is important because high levels of background gammas from the walls can be discriminated against by requiring a signal above the Thorium threshold.  Timing information is critical because it distinguishes particle energies.  The detectors are equipped with photomultiplier tubes (PMT's) at the top and bottom that have excellent timing response - their risetime is approximately 5 ns.  Constant Fraction Discriminators (CFD's) give timing information with jitter that's less than 1 ns.
