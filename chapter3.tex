...
\end{tabular}
\caption[Properties of the plastic scintillator used as the neutron detector.]{Properties of the plastic scintillator used as the neutron detector. Values are taken from \citep{BC408}.}
\label{tab:BC408}
\end{table}
