...
\caption[Timing spectrum for \MgReactions.]{The 6$^{\circ}$ TOF spectrum for \MgReaction.  The light output threshold is set at 7.2 MeVee.  A solid arrow indicates the ground state neutron peak and a hollow arrow the $\gamma$ peak due to beam hitting the target.}
\label{fig:MgTOF}
\end{figure}
