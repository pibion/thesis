...
\centering
\begin{tabular}{lll}
Properties & BCF-91A Multi-Clad WLS & Clear-PSMJ Multi-Clad Optical\\
\hline
Diameter, mm & 1.0 & 1.2\\
...
\end{comment}
Sixteen veto paddles were initially mounted $\sim$2~cm in front of the neutron detector bars to avoid removing them and potentially causing damage.  See {\fig}~\ref{fig:finalMount} for a detailed view. 
...
\caption{(a) The veto paddles are secured to the neutron detector bars with an additional retaining bar.  (b) A veto paddle and a neutron bar are secured together with a single aluminum bar to minimize their separation.  Stiff rubber (in orange) on either sides of the veto paddle again protects the scintillator from any point pressures that could result from its uneven surface.}
...
\caption{(a) The final arrangement of the veto paddles on a segment of the neutron detector.  The distance between the veto paddles and the bars of the neutron detector have been minimized.  (b) A bird's eye view of the neutron detector and veto paddles.  Note the addition of veto material on the sides of the neutron detector sub-units.}
\label{fig:vetoSetup}
\end{figure}
