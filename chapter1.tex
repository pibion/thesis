...
\caption{Double beta decay.  Both the observed \tvbb and the hypothesized \zvbb modes are shown.  Figure from {\refref}~\cite{zvbbReview_Elliott}.}
\label{fig:zvbb}
\end{figure}
