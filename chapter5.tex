...
\\
\subfloat[][]{
   \includegraphics[width=0.7\textwidth]{figures/76ge-4-adjusted.eps}
...
\centering
\subfloat[][]{
   \includegraphics[width=0.6\textwidth]{figures/74Ge_angularDist.eps}
}\\
\subfloat[][]{
   \includegraphics[width=0.6\textwidth]{figures/76Ge_angularDistribution.eps}
}
...
\begin{figure}[hp]
\centering
\includegraphics[width=1.0\textwidth]{figures/SigmaNormVsN.eps}
